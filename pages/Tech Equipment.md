...
</a><a rel="noopener noreferrer nofollow" href="www" class="isomer-card"><div class="isomer-card-image"><div class="isomer-image-wrapper"><img style="width: 100%" height="auto" width="100%" alt="Sigma" src="/images/chemical_testing.jpg"></div></div><div class="isomer-card-body"><div class="isomer-card-title">Sigma: Singapore Polytechnic</div><div class="isomer-card-description">Sigma is a NABL certified, ISO 17025 accredited laboratory with advanced solutions for temperature simulation and environmental testing chambers with constant or cyclic temperatures ranging from -80°C to +350°C, using walk-in chambers, smaller chambers, Automated thermal shock testing and more.</div><div class="isomer-card-link">askpolite@np.edu.sg</div></div></a>
<a rel="noopener noreferrer nofollow" href="www" class="isomer-card">
<div class="isomer-card-image">
<div class="isomer-image-wrapper">
